...
class MotionGenerationModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("ptl/train_loss", tot_loss, prog_bar=True)
        # return tot_loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("ptl/val_loss", tot_loss, prog_bar=True)
        return {"val_loss": tot_loss}
...
if __name__ == "__main__":
    model_name = "MoE_Test_10_autoregressive_improved_hopefully"
