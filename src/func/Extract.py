...
def parseFloat3(struct:dict) -> np.ndarray:
    ...
    :param struct {'x':float, 'y':float, 'z':float}
    :return: np.ndarray (3,)
    """
...
def parseFloat4(struct:dict) -> np.ndarray:
    ...
    :param struct {'x':float, 'y':float, 'z':float, 'w':float}
    :return: np.ndarray (4,)
    """
...
def parseFloat3x3(struct:dict) -> np.ndarray:
    ...
    :param struct {'c0':float3, 'c1':float3, 'c2':float3}
...
def parseFloat2x3(struct:dict) -> np.ndarray:
    """
    Reconstructs a Unity Matrix2x3 as a numpy array of shape (2,3)
    :param struct {'c0':float3, 'c1':float3}
    :return: np.ndarray (2,3)
    """
    return np.column_stack(
