...
from motion_generation_models.MoE import MoE
from motion_generation_models.MoE_Z import MoE as MoE_Z
import motion_generation_models
from motion_generation_models.GRU import GRU
from motion_generation_models.GRU_Z import GRU as GRU_Z
from motion_generation_models.LSTM import LSTM
from motion_generation_models.LSTM_Z import LSTM as LSTM_Z

from motion_generation_models.MotionGeneration import MotionGenerationModel as MoGen
from motion_generation_models.MotionGenerationEmbedd import MotionGenerationModel as MoGenZ
from motion_generation_models.MotionGenerationVAE import MotionGenerationModel as MoGenVAE
from motion_generation_models.MotionGenerationVAE_Embedd import MotionGenerationModel as MoGenVAE_Z
...
def fit(model, name, version="0.1", MIN_EPOCHS=20, MAX_EPOCHS=100, useEarlyStopping=False, patience=10):
    ...
    trainer = pl.Trainer(
        default_root_dir="/home/nuoc/Documents/MEX/src/motion_generation_models/checkpoints",
        gpus=1, precision=16,
        callbacks= callbacks,
...
for path in data_paths:
    ...
    print("YOMAMA")
    res = fit(ae, name=ae_name, version="new", MAX_EPOCHS=200)
