...
def train_model(config, name,featureDim, feature_dims,
    ...
    pretrained_model = "G:/MEX/models/AE_LSTM_256_ZIN0_F_R1_LSTM/final.pbz2"
    if config["C"] != "None":
    ...
    pretrained_model = MoGenNet.load_checkpoint(filename=pretrained_model, Model=G, MiddleModel=c_layer_2)
