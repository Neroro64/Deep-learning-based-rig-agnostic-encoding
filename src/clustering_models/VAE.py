...
"""
based on Motion VAE by Fabio Zinno et al. {https://github.com/electronicarts/character-motion-vaes/blob/main/vae_motion/models.py}
"""
...
class VAE(pl.LightningModule):
    """
        A extended MLP network with VAE layer at the end of the encoder
        ...
        Returns:
            (pytorch_lightning.LightninigModule) VAE model
    """
