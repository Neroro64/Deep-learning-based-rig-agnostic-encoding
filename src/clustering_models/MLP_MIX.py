...
class MLP_MIX(pl.LightningModule):
    """
        A extended MLP network with an additional MLP layer at the end of the encoder functioning as the clustering model
        ...
        Returns:
            (pytorch_lightning.LightninigModule) MLP_Mix model
    """
