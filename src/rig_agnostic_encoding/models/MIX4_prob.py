...
class MIX4_prob(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("ptl/val_kl_loss", kl_loss)
        self.log("ptl/val_recon_loss", recon_loss)
    ...
    def load_checkpoint(model, filename):
        ...
        model = MIX4_prob(model=model, name=obj["name"], load=True)
        model.model1 = model1
        model.model2 = model2
        model.model3 = model3
        model.model4 = model4
