...
class MotionGenerationModelRNNBatch(pl.LightningModule):
    ...
    def load_checkpoint(filename, Model):
        ...
        model = MotionGenerationModelRNNBatch(config=obj["config"], feature_dims=obj["feature_dims"],
    ...
    def swap_pose_encoder(self, pose_encoder=None, input_dim=0, feature_dims=None, freeze=False):
        self.pose_autoencoder = pose_encoder
        self.input_dims[1] = input_dim
        self.feature_dims = feature_dims
